package Playtomic.type{
	...
	public class SaveAndListOptions extends Object{
		//public var facebook:Boolean = false;//detecting if PlayerScore.FBuserId is set.
		...
		public function SaveAndListOptions(allowduplicates:Boolean=false, global:Boolean = true, highest:Boolean = true, mode:String = "MODE.ALL", customfilters:Object = null, perpage:int = 20, facebook:Boolean = true, friendslist:Array = null){
